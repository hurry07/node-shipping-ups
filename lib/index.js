...
function UPS(args) {
  ...
  $scope.buildRatesRequest = function (data, options) {
    ...
    const root = builder.create("RatingServiceSelectionRequest", {
      headless: true,
    });
    let request = {
      Request: {
  ...
  $scope.buildFreightShipRequest = function (
    ...
    */
    ...
    let body_request = builder.create("Request", { headless: true });
    let body_shipment = builder.create("Shipment", { headless: true });
